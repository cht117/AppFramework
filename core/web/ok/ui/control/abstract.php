...
/**
 * 定义 OK_UI_Control_Abstract 类
 *
 * @package webcontrols
 */

/**
 * OK_UI_Control_Abstract 是用户界面控件的基础类
 *
 * @package webcontrols
 */
abstract class OK_UI_Control_Abstract
{
    /**
     * 运行时上下文
     *
     ...
     * @var string
     */
    protected $_render_class = 'OK_View_Render_PHP_Parser';

    /**
     * 视图渲染对象
     *
     * @var OK_View_Render_PHP
     */
    protected $_render;
    ...
    {
        $this->_context = OK_Context::instance();
        $this->_id = $id;
        $this->_attrs = $attrs;
    }
     ...
     *
     * @return string|OK_UI_Control_Abstract
     */
    function id($id = null)
    {
        if (!is_null($id))
        ...
        if(!empty($this->_attrs['ok_form_group_id']))
        {
            return "{$this->_attrs['ok_form_group_id']}_{$this->_id}";
        }
        else
        {
            return $this->_id;
     ...
     *
     * @return array|OK_UI_Control_Abstract
     */
     ...
     * 显示一个控件
     *
     * @param OK_View_Render_PHP $render
     *
     * @return mixed
     */
    function display($render = null)
    {
        if ($render instanceof OK_View_Render_PHP_Parser)
        {
            $this->_render = $render;
        }
        echo $this->render();
    ...
    protected function _fetchView($filename, array $more_vars = null)
    {
        ...
        */
        ...
        {
            $filename = OK::ini('app_config/APP_DIR') . DS
    ...
    {
        $exclude = OK::normalize($exclude);
        $exclude[] = 'ok_form_group_id';
