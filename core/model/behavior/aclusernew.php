 ...
 * @package behavior
 */
class Model_Behavior_AclUserNew extends OK_ActiveRecord_Behavior_Abstract
{
    /**
     * 插件的设置信息
     *
     ...
     *
     * @return OK_ActiveRecord_Abstract 用户对象
     ...
     * @endcode
     *
     * @param OK_ActiveRecord_Abstract $member 要检查的用户对象
     * @param string $password 检查密码
     *
     * @return boolean 检查结果
     */
    function checkPasswordDyn(OK_ActiveRecord_Abstract $member, $password)
    {
     ...
     * @endcode
     *
     * @param OK_ActiveRecord_Abstract $member 要更新密码的用户对象
     * @param string $new_password 新密码
     * @param string $old_password 旧密码
     * @param boolean $ignore_old_password 是否忽略对旧密码的检查，默认为 false
     *
     ...
     */
    function changePasswordDyn(OK_ActiveRecord_Abstract $member,
     ...
     * @endcode
     *
     * @param OK_ActiveRecord_Abstract $member 要更新登录信息的用户对象
     * @param array $data 自行指定的属性值
     */
    function updateLoginDyn(OK_ActiveRecord_Abstract $member, array $data = null)
    {
     ...
     * @endcode
     *
     * @param OK_ActiveRecord_Abstract $member 用户对象
     *
     * @return array 包含角色名的数组
     */
    function aclRolesDyn(OK_ActiveRecord_Abstract $member)
    {
        $roles = array();
     ...
     * 获得用户的 ACL 数据
     *
     * ACL 数据一般包含用户 ID 和用户名，通常用于配合 OK_ACL 实现基于角色的访问控制。
     *
     * 用法：
     * @code php
     * $data = $member->aclData();
     ...
     */
    function aclDataDyn(OK_ActiveRecord_Abstract $member, $props = null)
    {
        if (!$props)
        {
     ...
     * @param OK_ActiveRecord_Abstract $member 用户对象
     */
    function _after_validate_on_create(OK_ActiveRecord_Abstract $member)
    {
     ...
     * @param OK_ActiveRecord_Abstract $member 用户对象
     */
    function _after_validate_on_update(OK_ActiveRecord_Abstract $member)
    {
        $pn = $this->_settings['password_prop'];
     ...
     *
     * @param OK_ActiveRecord_Abstract $member 保存出错的用户对象
     * @param Exception $ex 异常
     */
    function _save_exception_handler(OK_ActiveRecord_Abstract $member, Exception $ex)
    {
