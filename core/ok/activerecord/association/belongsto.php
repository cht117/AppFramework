<?php
/**
 * 定义 OK_ActiveRecord_Association_BelongsTo 类
 *
 * @package orm
 */

/**
 * OK_ActiveRecord_Association_BelongsTo 类封装 ActiveRecord 对象之间的 belongs to 关联
 *
 * @package orm
 */
class OK_ActiveRecord_Association_BelongsTo extends OK_ActiveRecord_Association_Abstract
{
