...
/**
 * 类 OK_Form 封装了表单的数据和行为
 *
 * 有关 OK_Form 类的详细使用，请参考开发者手册的相关章节。
 *
 * @package form
 */
class OK_Form extends OK_Form_Group
{
    /**
     * 表单方法类型
     */
     ...
     * OK_Form 继承类可以在 _after_created() 方法中做进一步的设置和初始化。
     *
     ...
     *
     * @return OK_Form 返回表单对象本身，实现连贯接口
     */
