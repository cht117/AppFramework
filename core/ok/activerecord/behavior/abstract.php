<?php
/**
 * 定义 OK_ActiveRecord_Behavior_Abstract 类
 *
 * @package orm
 */

/**
 * OK_ActiveRecord_Behavior_Abstract 抽象类是所有行为插件的基础类
 *
 * @package orm
 */
abstract class OK_ActiveRecord_Behavior_Abstract implements OK_ActiveRecord_Callbacks
{
     ...
     * 构造函数
     *
     * @param OK_ActiveRecord_Meta $meta
     * @param array $settings
     */
    function __construct(OK_ActiveRecord_Meta $meta, array $settings)
    {
        $this->_meta = $meta;
