<?php
/**
 * 定义 OK_Adapter_Pdo_Pgsql 类
 *
 * @package database
 */

/**
 * OK_Adapter_Pdo_Pgsql 类提供对 PostgreSQL 的支持
 *
 * @package database
 */
class OK_Adapter_Pdo_Pgsql extends OK_Adapter_Pdo_Abstract {
    ...
    function metaColumns($table_name, $schema = null)
    {
        ...
        /* @var $rs OK_Result_Abstract */
        $retarr = array();
        $cnt111 = 0;
        $rs->fetchMode = OK_DB::FETCH_MODE_ARRAY;
