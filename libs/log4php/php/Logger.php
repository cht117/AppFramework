 ...
 * @version	   SVN: $Id: Logger.php 61110 2011-05-10 08:10:57Z hanyf $
...
class Logger {
	private static $_classes = array(
		...
		'LoggerAppenderZeroMQ' => '/appenders/LoggerAppenderZeroMQ.php',
		'LoggerAppenderZmqFile' => '/appenders/LoggerAppenderZmqFile.php',
	 ...
	 */
	public function perf($name)
	{
		$this->messagePrefix = "PERF {$name} ";
		return $this;
	}
	...
	public function debug($message, $caller = null) {
		if ($this->messagePrefix) $message = $this->messagePrefix . $message; 
	...
	public static function initialize() {
		...
		Logger::configure(dirname(dirname(__FILE__)).'/config/log4php.properties');
